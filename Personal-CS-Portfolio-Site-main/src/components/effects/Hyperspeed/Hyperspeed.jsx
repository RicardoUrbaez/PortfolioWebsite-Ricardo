...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    (function () {
      ...
      options.distortion = distortions[options.distortion] || distortions.LongRaceDistortion;
      ...
      try {
        ...
        myApp
          ...
          .then(myApp.init)
          .catch(error => {
            console.error('Hyperspeed asset load failed:', error);
          });
      } catch (error) {
        console.error('Hyperspeed initialization failed:', error);
      }
    })();
